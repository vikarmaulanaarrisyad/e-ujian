...
router.post('/upload-photos', (0, rbac_middleware_1.requireRoles)(client_1.Role.ADMIN, client_1.Role.STAFF), upload_middleware_1.upload.single('file'), student_controller_1.uploadPhotos);
router.post('/archive', (0, rbac_middleware_1.requireRoles)(client_1.Role.ADMIN), student_controller_1.archiveStudents);
...
// Graduation routes
router.patch('/:id/graduation', (0, rbac_middleware_1.requireRoles)(client_1.Role.ADMIN, client_1.Role.STAFF), student_controller_1.updateGraduationStatus);
router.post('/graduation/batch', (0, rbac_middleware_1.requireRoles)(client_1.Role.ADMIN, client_1.Role.STAFF), student_controller_1.batchUpdateGraduation);
router.post('/graduation/assign-skl-numbers', (0, rbac_middleware_1.requireRoles)(client_1.Role.ADMIN, client_1.Role.STAFF), student_controller_1.batchAssignSklNumbers);
