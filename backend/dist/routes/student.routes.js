...
router.post('/delete-photos/batch', (0, rbac_middleware_1.requireRoles)(enums_1.Role.ADMIN, enums_1.Role.STAFF), student_controller_1.batchDeletePhotos);
...
router.delete('/:id/photo', (0, rbac_middleware_1.requireRoles)(enums_1.Role.ADMIN, enums_1.Role.STAFF), student_controller_1.deleteStudentPhoto);
router.delete('/:id', (0, rbac_middleware_1.requireRoles)(enums_1.Role.ADMIN), student_controller_1.deleteStudent);
// Graduation routes
router.get('/graduation/export', (0, rbac_middleware_1.requireRoles)(enums_1.Role.ADMIN, enums_1.Role.STAFF, enums_1.Role.GURU), student_controller_1.exportGraduationData);
