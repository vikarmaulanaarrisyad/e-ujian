...
router.put('/', (0, rbac_middleware_1.requireRoles)(enums_1.Role.ADMIN), upload_middleware_1.uploadImage.fields([{ name: 'logo', maxCount: 1 }, { name: 'signature', maxCount: 1 }]), school_controller_1.updateSchoolProfile);
