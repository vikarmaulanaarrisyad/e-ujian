...
// Subjects route
router.get('/subjects', (0, rbac_middleware_1.requireRoles)(client_1.Role.ADMIN, client_1.Role.GURU, client_1.Role.STAFF), grade_controller_1.getSubjects);
// Weight Configuration
router.get('/weight', (0, rbac_middleware_1.requireRoles)(client_1.Role.ADMIN, client_1.Role.GURU, client_1.Role.STAFF), grade_controller_1.getGradeWeight);
router.put('/weight', (0, rbac_middleware_1.requireRoles)(client_1.Role.ADMIN), grade_controller_1.updateGradeWeight);
// Report card grades Sem 7-11
router.get('/reports', (0, rbac_middleware_1.requireRoles)(client_1.Role.ADMIN, client_1.Role.GURU, client_1.Role.STAFF), grade_controller_1.getReportGrades);
router.post('/reports', (0, rbac_middleware_1.requireRoles)(client_1.Role.ADMIN, client_1.Role.GURU, client_1.Role.STAFF), grade_controller_1.saveReportGrades);
router.get('/reports/export', (0, rbac_middleware_1.requireRoles)(client_1.Role.ADMIN, client_1.Role.GURU, client_1.Role.STAFF), grade_controller_1.exportReportGrades);
router.get('/reports/export-all', (0, rbac_middleware_1.requireRoles)(client_1.Role.ADMIN, client_1.Role.GURU, client_1.Role.STAFF), grade_controller_1.exportAllReportGrades);
router.post('/reports/import', (0, rbac_middleware_1.requireRoles)(client_1.Role.ADMIN, client_1.Role.STAFF), upload_middleware_1.upload.single('file'), grade_controller_1.importReportGrades);
router.post('/reports/import-all', (0, rbac_middleware_1.requireRoles)(client_1.Role.ADMIN, client_1.Role.STAFF), upload_middleware_1.upload.single('file'), grade_controller_1.importAllReportGrades);
// Exam grades
