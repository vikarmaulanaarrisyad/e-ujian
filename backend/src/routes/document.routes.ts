...
import { getStudentDocumentData, getAllGraduatedSklData, getStudentSknrData, getBatchTkaStatementData, getAllGraduatedSknrData } from '../controllers/document.controller';
...
router.get('/sknr-batch', requireRoles(Role.ADMIN, Role.STAFF), getAllGraduatedSknrData);
