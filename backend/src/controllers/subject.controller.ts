...
export const createSubject = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const subject = await (prisma.subject.create as any)({
      data: {
        name,
...
export const updateSubject = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const updatedSubject = await (prisma.subject.update as any)({
      where: { id, tenantId },
      data: {
        name,
...
export const getSubjectTemplate = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const tenantId = (req as any).user.tenantId;
...
export const importSubjects = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const tenantId = (req as any).user.tenantId;
    if (!req.file) {
